...
IXO Engine — визуальный движок приложений, объединяющий node-логику в стиле Entry и Canvas Builder. Пользователь соединяет узлы, строит поток выполнения, проектирует интерфейс в Canvas Builder и экспортирует проект для Windows и Linux.

Версия документации: V1.1.3.
