...
GetSystemMetrics - Main

> [!IMPORTANT]
> We are making this project for just notice our project and download some useful apps  
> thx for using this project.

> [!TIP]
> Bug reports are welcome!!
We accept bug reports regardless of email, Discord, or other sources. 
...
> [!IMPORTANT]
> 저희는 이 프로젝트를 저희의 프로젝트 공지와 저희의 유용한 앱 다운로드를 위한 수단으로써만 쓰고있습니다.
> 이 프로젝트를 이용해주셔서 감사합니다.

> [!TIP]
> 버그 신고는 환영입니다!!  
메일, 디스코드 등등 가리지 않고 버그 신고 받습니다.
