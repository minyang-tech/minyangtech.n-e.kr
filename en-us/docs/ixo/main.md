...
IXO Engine is a visual app engine that combines Entry-style node logic with Canvas Builder. Users connect nodes to build execution flows, design real interfaces in Canvas Builder, and export projects for Windows and Linux.

Current documentation target: V1.1.3.
